                ...
                if (findTargetGO != null)
                {
                    ...
                    */
                    ...
                    if (itemDataArray[i, 1] == "CrashMountainRegion")
                    {
                        ...
                        {
                            switch (Settings.Instance.TMMHWindows)
                            {
                                case 0: //default
                        ...
                        {
                            if (Settings.Instance.TMMHRemoveFAKit) findTargetGO.SetActive(false);
                            else findTargetGO.SetActive(true);

                            if (Settings.Instance.TMMHMoveFAKit)
                            {
                                findTargetGO.transform.position = new Vector3(
                                    Settings.Instance.TMMHFAKPosX,
                                    Settings.Instance.TMMHFAKPosY,
                                    Settings.Instance.TMMHFAKPosZ
                                );
                                findTargetGO.transform.rotation = Quaternion.Euler(
                                    Settings.Instance.TMMHFAKRotX,
                                    Settings.Instance.TMMHFAKRotY,
                                    Settings.Instance.TMMHFAKRotZ
                                );
                            }
                            else
                            {
                        ...
                        {
                            if (Settings.Instance.TMMHRemoveBeds && findTargetGO.scene.name == itemDataArray[i, 1]) findTargetGO.SetActive(false);
                            else findTargetGO.SetActive(true);
                        }
                        // WorkBench ------------------------------------------------------------------------------------------
                        if (itemDataArray[i, 2] == "INTERACTIVE_WorkBench")
                        {
                            if (Settings.Instance.TMMHRemoveWorkbench) findTargetGO.SetActive(false);
                            else findTargetGO.SetActive(true);
                        }
                        // Roof ------------------------------------------------------------------------------------------
                        if (itemDataArray[i, 2] == "STR_StoneCabinATrapDoor")
                        {
                            if (Settings.Instance.TMMHCloseRoof)
                            {
                                if (GameObject.Find("STR_StoneCabinATrapDoor(Clone)")) continue;
                                else
                                {
                            ...
                            else if (GameObject.Find("STR_StoneCabinATrapDoor(Clone)")) Destroy(GameObject.Find("STR_StoneCabinATrapDoor(Clone)"), 0.5f);
                        }
                        // Indoor Temp ------------------------------------------------------------------------------------------
                        if (itemDataArray[i, 2] == "STR_StoneCabinA_Prefab/TRIGGER_IndoorSpace") findTargetGO.GetComponent<IndoorSpaceTrigger>().m_TemperatureDeltaCelsius = Settings.Instance.TMMHTemp;
                    }
                    ...
                    if (itemDataArray[i, 1] == "CoastalRegion")
                    {
                        ...
                        if (itemDataArray[i, 2] == "INTERACTIVE_BedMattressB")
                        {
                            if (Settings.Instance.CHALRemoveBeds && findTargetGO.scene.name == itemDataArray[i, 1]) findTargetGO.SetActive(false);
                            else findTargetGO.SetActive(true);
                        }
                        // Cupboard ------------------------------------------------------------------------------------------
                        if (itemDataArray[i, 2] == "CONTAINER_Cupboard")
                        {
                            if (Settings.Instance.CHALRemoveCupBoard) findTargetGO.SetActive(false);
                            else findTargetGO.SetActive(true);
                        }
                    }
                    // ==============================================================================================================
                    ...
                    if (itemDataArray[i, 1] == "LakeRegion")
                    {
                        ...
                        if (itemDataArray[i, 2] == "INTERACTIVE_BunkBed")
                        {
                            ...
                            if (Settings.Instance.MLFLRemoveBeds && findTargetGO.scene.name == itemDataArray[i, 1]) findTargetGO.SetActive(false);
                            else findTargetGO.SetActive(true); 
                        }
                    }
                    // ==============================================================================================================
                    ...
                    if (itemDataArray[i, 1] == "CanneryRegion_SANDBOX")
                    {
                        ...
                        if (itemDataArray[i, 2] == "INTERACTIVE_BedMattressB")
                        {
                            if (Settings.Instance.BIPLRemoveBeds && findTargetGO.scene.name == itemDataArray[i, 1]) findTargetGO.SetActive(false);
                            else findTargetGO.SetActive(true);
                        }
                    }
                }
