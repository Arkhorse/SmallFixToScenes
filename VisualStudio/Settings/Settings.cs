namespace SmallFixToScenes
{
    internal class Settings : JsonModSettings
    {
        ...
        [Name("Remove Bed")]
        [Description("Remove the bed. It is necessary to reload the file after the change.")]
        ...
        [Description("Remove the bunk beds. It is necessary to reload the file after the change.")]
